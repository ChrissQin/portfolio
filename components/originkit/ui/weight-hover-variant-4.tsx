...
export default function VariableFontHoverByLetter(props: Record<string, unknown>) {
  return <__OriginkitBase_VariableFontHoverByLetter {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
